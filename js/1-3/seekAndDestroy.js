...
console.log(destroyerAlt([1, 2, 3, 1, 2, 3], 2, 3)); // should return [1, 1]
console.log(destroyerAlt([1, 2, 3, 5, 1, 2, 3], 2, 3)); // should return [1, 5, 1]
console.log(destroyerAlt([3, 5, 1, 2, 2], 2, 3, 5)); // should return [1]
console.log(destroyerAlt([2, 3, 2, 3], 2, 3)); // should return []
console.log(destroyerAlt(["tree", "hamburger", 53], "tree", 53)); // should return ["hamburger"]
console.log(destroyerAlt(["possum", "trollo", 12, "safari", "hotdog", 92, 65, "grandma", "bugati", "trojan", "yacht"], "yacht", "possum", "trollo", "safari", "hotdog", "grandma", "bugati", "trojan")); // should return [12,92,65]